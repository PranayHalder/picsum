 ...
 <div className="relative flex justify-start md:justify-center mt-16 pb-3 md:items-end bg-[#faf1ec]">
        ...
        <div className="flex   pt-16  px-4 md:px-6  xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
            ...
            <div className="mt-12 flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
                <p className="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-black" >&copy; 2022 Picsum. All Rights Reserved</p>
